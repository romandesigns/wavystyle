...
const Author = ({ params: user }: { params: string }) => {
  return (
    <PageLayout showAurora showCanvas>
        ...
        <div className="container h-full grid grid-cols-1 grid-rows-1 items-center">
          <div>
            <section className="grid grid-cols-[1fr_35%] relative z-[2] gap-4">
              <article className="flex flex-col items-start bg-[#05060f]/50 p-6 rounded-lg">
                ...
                <button className="rounded-md bg-brand-cool">
                  <a
                    ...
                    className="p-4 px-10 block text-sm text-white font-bold uppercase"
                  >
                    Contact Roman
                  </a>
                </button>
              </article>
              <article className=" bg-[#05060f]/50 p-6 rounded-lg">
